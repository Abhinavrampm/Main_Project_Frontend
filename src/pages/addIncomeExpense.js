...
const AddIncomeExpense = () => {
    ...
    const fetchTransactions = async () => {
        try {
            const response = await axios.get("http://localhost:5000/api/auth/getTransactions");
    ...
    const handleSave = async () => {
        try {
            const response = await axios.post("http://localhost:5000/api/auth/addTransaction", formData);
            Swal.fire({
                title: "Success",
    ...
    const handleDelete = async (id) => {
        try {
            const response = await axios.delete(`http://localhost:5000/api/auth/deleteTransaction/${id}`);
            Swal.fire({
                title: "Success",
