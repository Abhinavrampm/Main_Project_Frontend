...
const AddJobs = () => {
    ...
    const fetchTransactions = async () => {
        try {
            const response = await axios.get("http://localhost:5000/api/auth/getJobPostings");
    ...
    const handleDelete = async (id) => {
        try {
            const response = await axios.delete(`http://localhost:5000/api/auth/deleteJobPosting/${id}`);
            Swal.fire({
                title: "Success",
